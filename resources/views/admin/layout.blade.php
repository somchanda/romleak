                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li><a href="{{route('logout')}}"><i class="icon-signout"></i> Logout </a>
                            </li>
                        </ul>
        ...
        <div id="left" >
            <div class="media user-media well-small">
                <a class="user-link" href="#">
                    <img class="media-object img-thumbnail user-img" style="width: 64px;height: 64px;" alt="User Picture" src="{{asset('images/users/'.Auth::user()->profile)}}" />
                </a>
                <br />
                <div class="media-body">
                    <h5 class="media-heading"> {{ucfirst(Auth::user()->name)}}</h5>
            ...
            <ul id="menu" class="collapse">
                <li class="panel {{(request()->segment(1) =='dashboard')?'active':''}}">
                    <a href="{{route('dashboard')}}" >
                        <i class="icon-table"></i> Dashboard
                    </a>
                </li>
                <li class="panel {{(request()->segment(1) =='post')?'active':''}}">
                    ...
                    <ul class="{{(request()->segment(1) == 'post')?'in':'collapse'}}" id="component-nav">
                        <li class="{{(request()->segment(2) == 'all')?'active':''}}"><a href="{{route('post.all')}}"><i class="icon-angle-right"></i> All Posts </a></li>
                        <li class="{{(request()->segment(2) == 'add')?'active':''}}"><a href="{{route('post.add')}}"><i class="icon-angle-right"></i> Add new </a></li>
                        <li class="{{(request()->segment(2) == 'category')?'active':''}}"><a href="{{route('post.category.all')}}"><i class="icon-angle-right"></i> Categories </a></li>
                    </ul>
                </li>
                <li class="panel ">
